...
if ($aksi == 'tambah') {
    ...
    if (move_uploaded_file($tmp_name, $folder . $foto)) {
        ...
        $db->tambahData($nama, $alamat, $nohp, $kelas, $nim, $jenis_kelamin, $foto, $email);
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (move_uploaded_file($tmp_name, $folder . $foto)) {
            ...
            $db->updateData($id, $nama, $alamat, $nohp, $kelas, $nim, $jenis_kelamin, $foto, $email);
        ...
        $db->updateData($id, $nama, $alamat, $nohp, $kelas, $nim, $jenis_kelamin, null, $email);
